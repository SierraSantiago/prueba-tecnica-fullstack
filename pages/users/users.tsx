          ...
          <tbody>
            {users.map((user) => (
              <tr key={user.id} className="hover:bg-gray-700">
                <td className="p-3 border border-black bg-white text-black">{user.name}</td>
                <td className="p-3 border border-black bg-white text-black">{user.email}</td>
                <td className="p-3 border border-black bg-white text-black">{user.phone ?? "-"}</td>
